...
console.log(currentSongs.tracks.duration);
return(
  <div className="flex items-center justify-around md:w-36 lg:w-52 2xl:w-80">
    ...
    {currentSongs?.nb_tracks && <MdSkipPrevious size={30} color="#FFF" className="cursor-pointer" onClick={handlePrevSong} />}
    {isPlaying ? (
    ...
    {currentSongs?.nb_tracks && <MdSkipNext size={30} color="#FFF" className="cursor-pointer" onClick={handleNextSong} />}
